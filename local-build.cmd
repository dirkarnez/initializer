...
cmake.exe -G"MinGW Makefiles" -DBOOST_ROOT="D:/Code Projects/cpp-libraries/boost-1.78.0-windows-2019-mingw-static/lib/cmake/Boost-1.78.0" -DCMAKE_BUILD_TYPE=Debug -B./build &&^
cd build &&^
cmake --build . &&^
